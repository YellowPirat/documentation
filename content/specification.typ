...
#figure(
  table(
    ...
    align: horizon,
    table.header( [*Name*], [*Startbit*], [*Endbit*], [*Length*], [*Comment*]),
    [peripheral_error],[0],[15],[5], [these 16 bits indicate error states in the cancore periphery],
...
#figure(
  table(
    ...
    align: horizon,
    table.header( [*Name*], [*Startbit*], [*Endbit*], [*Length*], [*Comment*]),
    [error_codes], [0], [15], [16], [these 16 bits indicate various error cases during reception],
    [frame_type],[16],[23],[8], [these 8 bits indicate the following frame type, such as CAN-2.0, CAN FD or newer versions like CAN XL]
