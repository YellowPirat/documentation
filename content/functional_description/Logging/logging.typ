...
Moreover, MCAP comes with useful visualization tools such as PlotJuggler @fig:plotjuggler and
...
contained within a single file. @fig:plotjuggler shows the userinterface, for this adventage.

Moreover, the data size is only slightly larger than that of a .blf file.


#figure(
image("img/plotjuggler.png", width: 100%),
caption: [Plotjuggler View]
)<fig:plotjuggler>